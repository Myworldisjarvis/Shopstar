			...
			<table class="vcats-table">
				...
				<tbody class="vcats-tbody">
					...
					for (Category category : categories) {
					    int productCount = 0;
					    try {
					        productCount = productDao.getProductCountByCategoryId(category.getCategoryID());
					    } catch (Exception e) {
					        out.println("Error fetching product count: " + e.getMessage());
					    }
					...
					<tr>
						...
						<td>
							<div class="vcats-action-buttons">
								<a href="UpdateCategory?id=<%=category.getCategoryID()%>"
									class="vcats-btn vcats-btn-warning">Update</a> <a
									href="DeleteCategory?action=delete&id=<%=category.getCategoryID()%>"
									class="vcats-btn vcats-btn-danger">Delete</a>
							</div>
						</td>
					</tr>
					<%
