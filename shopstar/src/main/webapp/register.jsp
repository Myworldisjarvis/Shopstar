                ...
                <div class="card-body">
                    ...
                    <form action="RegisterServlet" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <input name="phonenumber" type="tel" class="form-control" id="Phone" placeholder="Enter Mobile Number" required>
                        </div>
                        <div class="form-group">
                            <label for="Address">User Address</label>
                            <textarea name="address" class="form-control" id="Address" style="height: 150px;" placeholder="Enter your address" required></textarea>
                        </div>
